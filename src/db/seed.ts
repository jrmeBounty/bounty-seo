...
async function seed() {
	...
	const [nairobiCbd, westlands, mombasa, kisumu] = await db
		...
		.values([
			{
				name: "Bounty Supermarket — Olive Inn",
				address: "Atto Digimall Ground floor, Olive Inn, Nakuru",
				city: "Nakuru",
				country: "Kenya",
				phone: "+254 700 000 001",
				website: "https://www.bountybasket.online",
				googlePlaceId: "ChIJFTF-QV6NKRgRN3XBPxj0Fr8",
				lat: -0.2701875,
				lng: 36.0358125,
				isActive: true,
			},
			{
				name: "Bounty Supermarket — Goodwill Plaza",
				address: "Goodwill Plaza Ground Floor, Nakuru",
				city: "Nakuru",
				country: "Kenya",
				phone: "+254 700 000 002",
				website: "https://www.bountybasket.online",
				googlePlaceId: "ChIJQZ3rbQCRKRgRhrCuOZaIzIo",
				lat: -0.3220625,
				lng: 36.1500625,
				isActive: true,
			},
			{
				name: "Bounty Supermarket — Hyrax Hill",
				address: "Hyrax Hill House, Nakuru",
				city: "Nakuru",
				country: "Kenya",
				phone: "+254 700 000 003",
				website: "https://www.bountybasket.online",
				googlePlaceId: "ChIJ9zKFFwCTKRgR007ebHlLmHI",
				lat: -0.2831875,
				lng: 36.1004375,
				isActive: true,
			},
			{
				name: "Bounty Supermarket — Imani Mall",
				address: "ACK Imani Mall, Ground Floor Nakuru-Kisumu Rd, Nakuru",
				city: "Nakuru",
				country: "Kenya",
				phone: "+254 700 000 004",
				website: "https://www.bountybasket.online",
				googlePlaceId: "ChIJJZL1MQCNKRgRMLAs5pxT9_c",
				lat: -0.2893373,
				lng: 36.0505835,
				isActive: true,
			},
	...
	const keywords = await db
		...
		.values([
			// Olive Inn — 6 keywords
			{
				locationId: nairobiCbd.id,
				term: "supermarket near me nakuru",
				category: "local",
				targetPosition: 3,
			},
			{
				locationId: nairobiCbd.id,
				term: "bounty supermarket nakuru",
				category: "branded",
				targetPosition: 1,
			},
			{
				locationId: nairobiCbd.id,
				term: "grocery store olive inn",
				category: "local",
				targetPosition: 3,
			},
			{
				locationId: nairobiCbd.id,
				term: "cheap groceries nakuru",
				category: "category",
				targetPosition: 5,
			},
			{
				locationId: nairobiCbd.id,
				term: "fresh produce nakuru",
				category: "category",
				targetPosition: 3,
			},
			{
			...
			// Goodwill Plaza — 6 keywords
			{
				locationId: westlands.id,
				term: "supermarket goodwill plaza nakuru",
				category: "local",
				targetPosition: 2,
			},
			{
				locationId: westlands.id,
				term: "bounty supermarket goodwill",
				category: "branded",
				targetPosition: 1,
			},
			{
				locationId: westlands.id,
				term: "grocery store nakuru cbd",
				category: "local",
				targetPosition: 3,
			},
			{
				locationId: westlands.id,
				term: "best supermarket nakuru",
				category: "category",
				targetPosition: 3,
			},
			{
				locationId: westlands.id,
				term: "weekly specials supermarket nakuru",
				category: "category",
				targetPosition: 5,
			},
			{
				locationId: westlands.id,
				term: "fresh meat nakuru",
				category: "category",
				targetPosition: 5,
			},

			// Hyrax Hill — 5 keywords
			{
				locationId: mombasa.id,
				term: "supermarket hyrax hill",
				category: "local",
				targetPosition: 2,
			},
			{
				locationId: mombasa.id,
				term: "bounty supermarket hyrax",
				category: "branded",
				targetPosition: 1,
			},
			{
				locationId: mombasa.id,
				term: "grocery store hyrax hill",
				category: "local",
				targetPosition: 3,
			},
			{
				locationId: mombasa.id,
				term: "supermarket rift valley",
				category: "category",
				targetPosition: 5,
			},
			{
				locationId: mombasa.id,
				term: "cheap groceries nakuru cbd",
				category: "category",
				targetPosition: 5,
			},

			// Imani Mall — 5 keywords
			{
				locationId: kisumu.id,
				term: "supermarket imani mall nakuru",
				category: "local",
				targetPosition: 2,
			},
			{
				locationId: kisumu.id,
				term: "bounty supermarket imani mall",
				category: "branded",
				targetPosition: 1,
			},
			{
				locationId: kisumu.id,
				term: "grocery store nakuru-kisumu rd",
				category: "local",
				targetPosition: 3,
			},
			{
				locationId: kisumu.id,
				term: "supermarket western nakuru",
				category: "local",
				targetPosition: 3,
			},
			{
				locationId: kisumu.id,
				term: "fresh vegetables nakuru",
				category: "category",
				targetPosition: 5,
			},
		])
